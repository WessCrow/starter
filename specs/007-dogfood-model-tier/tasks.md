...
|------|-----|-----|---------|------|-------------|
| [x] | T1 | — | `skills/infra/scripts/validate-skills.py` | Adicionar `validate_model_orchestration_log()`: exige `model-orchestration.md` com seções "Log de testes (TDD)", "Racionalizações proibidas", linhas RED/GREEN/REFACTOR; `AGENTS.md` contém `0g` | `python3 skills/infra/scripts/validate-skills.py` PASS |
