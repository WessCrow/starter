...
| Nova feature (spec-driven) | `governance/feature-flow.md` → `templates/specs/` → `qa-gate` |
...
| Bug / erro / build quebrado | `governance/debugging-protocol.md` → `verify-before-done` |
| Feedback / crítica do usuário | `governance/review-reception.md` |
| Criar / editar skill ou regra | `governance/skill-testing.md` (TDD RED→GREEN) |
| Avaliar skill candidata | `governance/skill-intake.md` |
| Economia de modelo / delegação | `governance/model-orchestration.md` (ver `AGENTS.md` §0g) |
