...
| `PRD.md` (raiz) | Idem |
| `skills/runtime/` (pasta inteira) | YAML do framework copiado |
...
| Caminho | Motivo |
|---------|--------|
| `skills/governance/` | Protocolos (kickoff, QA, etc.) |
...
| `skills/scripts/` | Scripts de bootstrap |
...
- **Não** rodar cleanup
- **Não** apagar `skills/runtime/` nem CONTEXT/PRD do app
