...
Uso:
  python3 skills/infra/scripts/check-repo-hygiene.py
  python3 skills/infra/scripts/check-repo-hygiene.py --staged   # só o que vai no próximo commit

Política: skills/flows/repo-hygiene.md
"""
...
def main() -> int:
    ...
    if violations:
        ...
        print("Política: skills/flows/repo-hygiene.md")
        return 1
