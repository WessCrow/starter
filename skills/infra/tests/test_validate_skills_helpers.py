...
class TestCheckStartLocalResolution:
    def test_pass_when_equal(self):
        start_text = "2. catalog/ → `qa-gate` · `qa-smoke`\n3. other"
    ...
    def test_fail_extra_in_start(self):
        start_text = "2. catalog/ → `qa-gate` · `ghost`\n3. other"
