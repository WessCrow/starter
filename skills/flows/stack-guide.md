...
As structure skills (`nextjs-structure.skill`, `react-vite-structure.skill`) devem chamar `bash skills/infra/scripts/patch-pnpm-workspace.sh` após o scaffold (ou gerar o mesmo conteúdo).
